...
module.exports = {
  ...
  try{
    ...
    res.render("admin/dashboard",{totalSales,totalPrice,totalOrders,totalUsers,totalBrands,tranCOD,tranRAZ,orderdash})
...
viewOrderDetails:async(req,res,next)=>{
  try{
   console.log('khklh')
    await orderModel.find().populate({path:'orderedItems',model:'orders',populate:{path:'brandname',model:'brandName'}})
.then(orderDetail=>{
